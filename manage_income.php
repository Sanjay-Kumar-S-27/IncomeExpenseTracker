<?php
include("session.php");
$exp_fetched = mysqli_query($con, "SELECT * FROM incomes WHERE user_id = '$userid'");
?>
<!DOCTYPE html>
<html lang="en">
    ...
    <div class="d-flex" id="wrapper">
        ...
        <div class="border-right" id="sidebar-wrapper">
            ...
            <div class="list-group list-group-flush">
                ...
                <a href="manage_income.php" class="list-group-item list-group-item-action sidebar-active"><span data-feather="edit-2"></span> Manage Incomes</a>
