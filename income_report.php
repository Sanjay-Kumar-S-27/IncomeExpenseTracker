<?php
  include("session.php");
  $exp_category_dc = mysqli_query($con, "SELECT incomecategory FROM incomes WHERE user_id = '$userid' GROUP BY incomecategory");
  $exp_amt_dc = mysqli_query($con, "SELECT SUM(income) FROM incomes WHERE user_id = '$userid' GROUP BY incomecategory");

  $exp_date_line = mysqli_query($con, "SELECT incomedate FROM incomes WHERE user_id = '$userid' GROUP BY incomedate");
  $exp_amt_line = mysqli_query($con, "SELECT SUM(income) FROM incomes WHERE user_id = '$userid' GROUP BY incomedate");
?>
<!DOCTYPE html>
<html lang="en">
  ...
  <div class="d-flex" id="wrapper">
    ...
    <div class="border-right" id="sidebar-wrapper">
      ...
      <div class="list-group list-group-flush">
        ...
        <a href="add_income.php" class="list-group-item list-group-item-action "><span data-feather="plus-square"></span> Add Incomes</a>
        ...
        <a href="income_report.php" class="list-group-item list-group-item-action sidebar-active"><span data-feather="bar-chart"></span> Income Reports</a>
      </div>
